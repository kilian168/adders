// bsd_ternary_adder2_exhaustive.cpp
#include <systemc.h>
#include <iostream>
#include <iomanip>
#include <string>
...
SC_MODULE(BalancedTernaryAdder2) {
    ...
    void print_report() {
        ...
        std::cout << "\n=======================================================\n";
        std::cout << "        2-TRIT BALANCED TERNARY ADDER SWITCH REPORT    \n";
        std::cout << "=======================================================\n";
        ...
        std::cout << "-------------------------------------------------------\n";
        std::cout << " GESAMTSUMME ALLER SWITCHES IM 2-TRIT BALANCED ADDER: "
                  << total_switches << "\n";
        std::cout << "=======================================================\n";
    }
...
// ============================================================================
// 3. TESTBENCH: EXHAUSTIVE RANGE 0..3 LIKE 2-BIT RCA WITHOUT CIN
// ============================================================================
SC_MODULE(Testbench) {
    sc_out<sc_lv<2>> A_a;
    sc_out<sc_lv<2>> A_b;
    ...
    void stimulus() {
        ...
        std::cout << "\n=======================================================\n";
        std::cout << "       EXHAUSTIVE 2-TRIT TERNARY ADDER TEST 0..3       \n";
        std::cout << "=======================================================\n";
        std::cout << " Nr | A_dec | B_dec | Expected | A_a | A_b | B_a | B_b | S_minus | S_plus\n";
        std::cout << "----+-------+-------+----------+-----+-----+-----+-----+---------+--------\n";
        ...
        std::cout << " Erwartete Anzahl: 16\n";
        std::cout << " Erwartete Ergebnissumme: 48\n";
        std::cout << "=======================================================\n";
